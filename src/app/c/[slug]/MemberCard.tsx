...
export function MemberCard({ member, rank, theme, statFields, formulaLabel, currentUserId, isAdmin, slug }: {
  ...
  const badges: BadgeDef[] = member.badges ?? []
  ...
  return (
    <>
      ...
      >
        ...
        <div style={{
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginTop: '2px', flexWrap: 'wrap' }}>
              ...
              {slug && (
                <a
                  href={`/c/${slug}/membre/${member.id}`}
                  style={{
                    fontSize: '0.62rem', color: theme.primaryColor,
        ...
        {/* Badges */}
        {badges.length > 0 && (
          <div style={{ padding: '0 18px 10px', display: 'flex', flexWrap: 'wrap', gap: '5px' }}>
            {badges.map((badge, i) => (
              <Badge key={i} badge={badge} size="sm" />
            ))}
          </div>
        )}
          ...
          <div style={{ padding: '12px 18px', borderTop: `1px solid ${theme.darkMode ? '#222' : '#eee'}` }}>
            <a
              ...
              style={{
                ...
                borderRadius: '4px', color: theme.primaryColor,
